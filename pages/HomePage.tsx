        ...
        <ScrollView style={{backgroundColor: '#003A5D'}}>
          ...
          <View style={styles.appWelcomeContainer}>
            <Text style={styles.appWelcomeText}>
              Welcome to the UC Davis Children's Surgery Center! This app was
              designed to be a source of helpful preparatory information for
              families. Scroll down to learn more about each of the features.
            </Text>
          </View>
          {DATA.map(item => {
            return (
